...
public class CSVServiceTest {
    @InjectMocks
    private CSVService csvService = new CSVService(new DateParser());
    ...
    public void testProcessCSVWithMultiplePairsAndProjects() {
        ...
        Pair expectedPair1 = new Pair(143, 145, 30);
        expectedPair1.getProjects().put(10, 10);
        expectedPair1.getProjects().put(12, 10);
        expectedPair1.getProjects().put(15, 10);
        Pair expectedPair2 = new Pair(147, 148, 30);
        expectedPair2.getProjects().put(17, 30);
